...
React JS is an open source JS library. It helps solve the need to constantly make functions. We dont have to make the same thing over and over we can have it in one place and reuse it. Like this project. 
1. Describe component state. It sets a state and when it changes the component responds.
1. Describe props. Props is used to pass data between components. We give it value when needed
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects when something happens when the function is executed. You use the effect hook to sync effects!